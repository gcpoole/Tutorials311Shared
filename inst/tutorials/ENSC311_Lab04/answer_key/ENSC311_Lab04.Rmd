...
Now that we have a sense of what's in the data set, some questions may come to mind.  For instance, I wonder if the individual species are segregated on specific islands?  Or, are the species are distributed across multiple islands?  Let's try to find out!
...
Search the internet for a description of the built-in color name in R.
...
- Convert the `years` column to a factor.
